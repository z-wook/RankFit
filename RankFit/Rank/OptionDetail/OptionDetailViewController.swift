...
extension OptionDetailViewController: UICollectionViewDelegate {
    func configCollectionView() {
        datasource = UICollectionViewDiffableDataSource<Section, Item>(collectionView: collectionView, cellProvider: { collectionView, indexPath, itemIdentifier in
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "OptionDetailRankCell", for: indexPath) as? OptionDetailRankCell else { return nil }
...
extension OptionDetailViewController: FSCalendarDelegate, FSCalendarDataSource, FSCalendarDelegateAppearance {
