...
extension ExerciseInfo {
    ...
    static let ExerciseInfoList: [ExerciseInfo] = [
        ...
        ExerciseInfo(exerciseName: "백 익스텐션", table_name: "backnailtension", group: 1),
        ...
        ExerciseInfo(exerciseName: "풀업", table_name: "pullup", group: 1),
        ...
        ExerciseInfo(exerciseName: "레그 레이즈", table_name: "legrise", group: 1),
        ExerciseInfo(exerciseName: "러시안 트위스트", table_name: "Russiantwist", group: 1),
        ExerciseInfo(exerciseName: "버피", table_name: "buffy", group: 1),
        ExerciseInfo(exerciseName: "줄넘기", table_name: "JumpRope", group: 2),
        ExerciseInfo(exerciseName: "마운틴 클라이머", table_name: "posterclimber", group: 1),
        ...
        ExerciseInfo(exerciseName: "이지바 컬", table_name: "EasyBarCurl", group: 1),
        ...
        ExerciseInfo(exerciseName: "행잉 레그 레이즈", table_name: "hanginglegrise", group: 1),
        ExerciseInfo(exerciseName: "푸시업", table_name: "pushup", group: 1)
    ]
}
